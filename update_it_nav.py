...
def run():
    ...
    try:
        ...
        # Replace the Information Technology search link
        new_setting_value = setting_value.replace("/courses?search=information technology", "/specializations/information-technology")
        ...
        print("Updated mainNavigation config for Information Technology:", post_response.status)
