...
def run():
    ...
    try:
        ...
        # Replace the computer science search link
        new_setting_value = setting_value.replace("/courses?search=computer science", "/specializations/computer-science")
        ...
        print("Updated mainNavigation config for Computer Science:", post_response.status)
