    ...
    categories: [
      {
        ...
        items: [
          ...
          { ar: "الذكاء الاصطناعي", en: "Artificial Intelligence", zh: "人工智能", href: "/courses?search=artificial" },
          { ar: "علوم البيانات", en: "Data Science", zh: "数据科学", href: "/courses?search=data science" },
          { ar: "علوم الحاسوب", en: "Computer Science", zh: "计算机科学", href: "/courses?search=computer science" },
          { ar: "تكنولوجيا المعلومات", en: "Information Technology", zh: "信息技术", href: "/courses?search=information technology" },
        ]
      },
      {
        ar: "الهندسة",
        ...
        zh: "工程",
        items: [
          { ar: "هندسة الحاسوب", en: "Computer Engineering", zh: "计算机工程", href: "/courses?search=computer engineering" },
          { ar: "الهندسة الطبية الحيوية", en: "Biomedical Engineering", zh: "生物医学工程", href: "/courses?search=biomedical" },
          { ar: "هندسة الميكاترونكس", en: "Mechatronics Engineering", zh: "机电工程", href: "/courses?search=mechatronics" },
          { ar: "هندسة الروبوتات", en: "Robotics Engineering", zh: "机器人工程", href: "/courses?search=robotics" },
