          ...
          <div className="bg-white dark:bg-[#0b0f19] rounded-[3rem] p-10 md:p-16 shadow-xl border border-gray-100 dark:border-gray-800">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg text-gray-800 dark:text-gray-200">{t.service_pages.s3_b1}</p>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle className="text-green-500 shrink-0 mt-1" size={24} />
                <p className="text-lg text-gray-800 dark:text-gray-200">{t.service_pages.s3_b2}</p>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle className="text-green-500 shrink-0 mt-1" size={24} />
                <p className="text-lg text-gray-800 dark:text-gray-200">{t.service_pages.s3_b3}</p>
              </div>
            </div>
