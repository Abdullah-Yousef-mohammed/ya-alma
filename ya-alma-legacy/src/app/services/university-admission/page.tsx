          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-16 shadow-xl border border-gray-100">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg text-gray-800">{t.service_pages.s1_b1}</p>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle className="text-green-500 shrink-0 mt-1" size={24} />
                <p className="text-lg text-gray-800">{t.service_pages.s1_b2}</p>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle className="text-green-500 shrink-0 mt-1" size={24} />
                <p className="text-lg text-gray-800">{t.service_pages.s1_b3}</p>
              </div>
            </div>
