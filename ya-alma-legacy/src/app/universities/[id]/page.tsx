        ...
        <div className="w-full xl:w-[68%] space-y-12">
          ...
          <section id="tour" className="bg-white dark:bg-[#0b0f19] rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-gray-800 p-8 md:p-12 scroll-mt-40 transition-all duration-500 hover:shadow-xl hover:shadow-gray-200/50">
            ...
            <div className="aspect-video rounded-[2.5rem] overflow-hidden bg-gray-900 relative shadow-2xl border-4 border-white">
              {isVideoPlaying ? (
                <iframe
                  src={`https://www.youtube.com/embed/${t_dyn(university.videoUrl, university.videoUrlAr || university.videoUrl, university.videoUrlZh || university.videoUrl, university.videoUrlMs || university.videoUrl)}?autoplay=1&controls=1&rel=0`}
                ...
                >
                  <img 
                    src={`https://img.youtube.com/vi/${t_dyn(university.videoUrl, university.videoUrlAr || university.videoUrl, university.videoUrlZh || university.videoUrl, university.videoUrlMs || university.videoUrl)}/maxresdefault.jpg`} 
                    ...
                    onError={(e) => { e.currentTarget.src = `https://img.youtube.com/vi/${t_dyn(university.videoUrl, university.videoUrlAr || university.videoUrl, university.videoUrlZh || university.videoUrl, university.videoUrlMs || university.videoUrl)}/hqdefault.jpg`; }}
                  />
