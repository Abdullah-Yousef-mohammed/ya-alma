        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
             ...
             <div className="space-y-8 relative">
               ...
               <div className="absolute left-6 top-8 bottom-8 w-0.5 bg-gray-100 dark:bg-gray-800 -z-10"></div>
               ...
               {steps.map((step, idx) => (
                 ...
                 >
                   <div className="flex-shrink-0 w-12 h-12 bg-white dark:bg-[#0b0f19] border-2 border-[var(--color-brand-navy)] text-[var(--color-brand-navy)] font-bold rounded-full flex items-center justify-center relative shadow-sm">
                     {step.num}
                   </div>
                   <div className="pt-2">
          ...
          <div className="order-first lg:order-last">
             <div className="aspect-square bg-gray-50 dark:bg-[#11192d] rounded-full sm:w-[500px] mx-auto relative border-4 border-[var(--color-brand-gold)]/20 shadow-[-20px_20px_60px_rgba(0,0,0,0.05)] p-4">
                ...
                <motion.div 
                  ...
                  className="absolute bottom-10 rtl:-right-10 ltr:-left-10 bg-white dark:bg-[#0b0f19] p-6 rounded-2xl shadow-xl flex items-center gap-4 border border-gray-100 dark:border-gray-800"
                >
                  ...
                  <div>
                    <div className="text-gray-900 dark:text-gray-100 font-bold">{t.process.float1}</div>
