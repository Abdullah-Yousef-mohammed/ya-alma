...
export default function WhyFree() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-gray-50 border-t border-gray-100 dark:border-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="order-2 lg:order-1 relative aspect-square md:aspect-video lg:aspect-square bg-gray-50 dark:bg-[#11192d] rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-2xl flex items-center justify-center overflow-hidden group"
          >
            ...
            <motion.div 
              ...
              className="relative bg-white dark:bg-[#0b0f19]/80 backdrop-blur-xl p-8 md:p-10 rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] max-w-[80%] text-center border border-white"
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">{t.why_free.official_rep}</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-6">
              {[
                ...
                <motion.li 
                  ...
                  className="flex items-center gap-4 text-xl text-gray-800 dark:text-gray-200 font-semibold group"
                >
            ...
            <div className="mt-12 flex items-center gap-6 p-6 bg-white dark:bg-[#0b0f19] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
